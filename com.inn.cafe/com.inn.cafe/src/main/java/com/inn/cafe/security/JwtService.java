...
public class JwtService {
    ...
    public String createToken(Map<String, Object> claims, String userName,  Date expires) {
        return Jwts.builder()
                .setClaims(claims)
                .setSubject(userName)
                .setIssuedAt(new Date(System.currentTimeMillis()))
                .setExpiration(expires == null ? new Date(System.currentTimeMillis() + 1000 * 60 * 30): expires)
